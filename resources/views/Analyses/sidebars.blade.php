            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                >
                  ...
                  <li
                    class="px-2 py-1 transition-colors border-green-400 border-l-4 duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full text-green-400" href="/tests">
                      Tests enregistres
                    </a>
                  </li>
