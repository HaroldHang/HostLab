...
<aside
      ...
      >
        <div class="py-4 text-gray-700 dark:text-gray-400">
          <a
          ...
          <ul class="mt-6">
            <li class="relative px-4 py-3 bg-transparent mx-2 border-green-400 border-l-4 mx-2 ">
              <a
                class="inline-flex items-center w-full text-sm font-semibold text-green-400 transition-colors duration-150  dark:hover:text-gray-200 dark:text-gray-100 "
                href="#"
              >
                <svg
                  class="w-5 h-5"
          ...
          <ul>
            <li class="relative px-6 py-3 bg-transparent  ">
              <a
              ...
              >
                ...
                <span class="ml-3">Demandes Analyses</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="{{route('echantillon.index')}}"
              >
                ...
                <span class="ml-4">Echantillons</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <button
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="{{route('echantillonType.index')}}">Type Echantillons</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="{{route('test.index')}}">
                      Tests enregistres
                    </a>
                  </li>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Historique Patients</span>
              </a>
            </li>
      ...
      >
        <div class="py-4 text-gray-700 dark:text-gray-400">
          ...
          <ul class="mt-6">
            <li class="relative px-4 py-3 bg-transparent mx-2 border-green-400 border-l-4 mx-2">
              <a
                class="inline-flex items-center w-full text-sm font-semibold text-green-400 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                href="#"
              >
                <svg
                  class="w-5 h-5"
                ...
                <span class="ml-4 text-green-400">Tableau de bord</span>
              </a>
            </li>
          </ul>
          <ul>
            <li class="relative px-4 py-3 bg-transparent  ">
              <a
              ...
              >
                ...
                <span class="ml-4">Demandes Analyses</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
