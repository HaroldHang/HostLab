                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    ...
                    >
                      ...
                      <th class="px-4 py-3">Nom du type echantillon </th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold">{{$echant->nom_type}}</p>
                      ...
                      <td class="px-5 py-3 text-xs">
                        <div class=" flex items-center">
                            <p class="font-semibold">
                                {{$echant->description_echantillon}}
                            </p>
                        </div>
                      </td>
                      <!--
                      ...
                      <td class="px-4 py-3 text-sm">
                        <div class="flex items-center space-x-4 text-sm">
                            <a
                              ...
                              aria-label="Edit" href="{{route('echantillonType.edit',$echant->identifiant_type)}}"
                            >
                              <svg
                                class="w-5 h-5"
                                aria-hidden="true"
                            ...
                            <button
                              class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-green-400 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                              aria-label="Delete" onclick="event.preventDefault(); document.getElementById('delete-echant-{{$echant->identifiant_type}}').submit()"
                            >
                              <svg
                                class="w-5 h-5"
                                aria-hidden="true"
                            ...
                            <form style="display:none;" id="{{'delete-echant-'.$echant->identifiant_type}}" method="post" action="{{route('echantillonType.destroy', $echant->identifiant_type)}}">
                              @csrf
                              @method('put')
                            </form>
                          </div>
