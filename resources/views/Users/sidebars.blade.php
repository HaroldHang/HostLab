...
<aside
      ...
      >
        <div class="py-4 text-gray-700 dark:text-gray-400">
          ...
          <ul class="mt-6">
            <li class="relative px-4 py-3 bg-transparent mx-2 ">
              <a
          ...
          <ul>
            <li class="relative px-4 py-3  ">
              <a
                class="inline-flex items-center w-full text-sm font-semibold  hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                href="/Demandes Analyse"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
            ...
            <li class="relative px-6 py-3">
              ...
              <template x-if="isPagesMenuOpen">
                ...
                >
                  ...
                  >
                    <a class="w-full" href="/echantillons type">Type Echantillons</a>
                  </li>
                  <li
                    class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                  >
                    <a class="w-full" href="/tests">
                      Tests enregistres
                    </a>
                  </li>
            ...
            <li class="relative px-6 py-3 bg-transparent border-green-400 border-l-4 mx-2">
              <a
                class="inline-flex items-center w-full text-sm font-semibold text-green-400 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
      ...
      >
        <div class="py-4 text-gray-700 dark:text-gray-400">
          ...
          <ul>
            ...
            <li class="relative px-6 py-3 bg-transparent border-green-400 border-l-4 mx-2 ">
              <a
                class="inline-flex items-center w-full text-sm text-green-400 font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="{{route('users.index')}}"
              >
                <svg
                  class="w-5 h-5"
