...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen }">
        <!-- Desktop sidebar -->
        @hasSection('desktop_navigation')
            @yield('desktop_navigation')
        @endif
        <!-- Mobile sidebar -->
        <!-- Backdrop -->
        <div
        ...
        ></div>
        @hasSection('mobile_navigation')
            @yield('mobile_navigation')
        @endif
        <div class="flex flex-col flex-1 w-full">
            <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                <div class="container flex items-center justify-between h-full px-6 mx-auto text-green-400 dark:text-purple-300">
                    <!-- Mobile hamburger -->
                    ...
                    <div class="flex justify-center flex-1 lg:mr-32">
                        <div class="relative w-full max-w-xl mr-6 focus-within:text-green-400">
                            <div class="absolute inset-y-0 flex items-center pl-2">
                                <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clip-rule="evenodd"></path>
                                </svg>
                            </div>
                            <input class="w-full h-10 pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-2 border-transparent rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:border-green-300 focus:outline-none focus:shadow-outline-purple form-input" type="text" placeholder="Chercher une analyse" aria-label="Search"/>
                        </div>
                    </div>
                                ...
                                >
                                    <li class="flex">
                                        <a class="inline-flex items-center justify-between w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200" href="#">
                                            <span>Echantillon Analyses</span>
                        ...
                        <li class="relative">
                            ...
                            >
                                <img
                                    ...
                                    src="{{asset('Images/male_avatar.png')}}"
                                    alt=""
                                    aria-hidden="true"/>
                            </button>
