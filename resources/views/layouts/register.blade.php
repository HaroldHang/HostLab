            ...
            <div @click.away="show = false" :class="{ 'block': show, 'hidden': !show }" class="w-full block flex-grow md:flex md:justify-end md:w-auto">
              <div>
                <!--<a href="#" class="block md:inline-block text-sm px-4 py-2 leading-none rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 md:mt-0">Home</a>--->
                 <a href="{{ route('login') }}" class="block md:inline-block text-base px-4 py-2 leading-none rounded text-white border-2 border-white hover:border-transparent hover:text-teal-500 hover:bg-green-600 mt-4 md:mt-0">Se connecter</a>
                <a href="{{ route('register') }}" class="block md:inline-block text-base px-4 py-2 leading-none rounded text-white border-2 border-transparent  hover:border-white  mt-4 md:mt-0  ">S'inscrire</a>
              </div>
            </div>
        </nav>
